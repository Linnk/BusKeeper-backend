...
//	this.htmlPlayer.controls = false;
	...
	if(this.htmlPlayer.hasAttribute("poster") && this.htmlPlayer.getAttribute("poster")!=""){
		this.poster = LionPlayer.poster(this.htmlPlayer.getAttribute("poster"));
		this.domelement.appendChild(this.poster);
	}
	this.playBtn = LionPlayer.playBtn(size);
	var playCenter = LionPlayer.playBtnCenter();
	playCenter.appendChild(this.playBtn);
	this.domelement.appendChild(playCenter);
	
	this.videoOverlay = LionPlayer.videoOverlay();
	this.domelement.appendChild(this.videoOverlay);
	this.controls = LionPlayer.controls();
	this.timeBar = LionPlayer.timeBar();
	this.controls.appendChild(this.timeBar);
	this.progressBar = LionPlayer.progressBar();
	this.timeBar.appendChild(this.progressBar);
	this.durationLabel = LionPlayer.durationLabel();
	this.controls.appendChild(this.durationLabel);
	this.progressLabel = LionPlayer.progressLabel();
	this.controls.appendChild(this.progressLabel);
	this.fullscreenBtn = LionPlayer.fullscreenBtn();
...
/*
	...
	*
*/
LionPlayer.prototype.videoOverlay = function(){
	var overlay = document.createElement("div");
	overlay.setAttribute('class', "videoOverlay showing");
	return overlay;
}
LionPlayer.prototype.controls = function(){
	var div = document.createElement("div");
	div.setAttribute('class', "controls");
	return div;
}
LionPlayer.prototype.poster = function(src){
...
LionPlayer.prototype.playBtnCenter = function(){
	var dot = document.createElement("div");
	dot.setAttribute('class', "playBtnCenter");
	return dot;
}
LionPlayer.prototype.playBtn = function(size){
